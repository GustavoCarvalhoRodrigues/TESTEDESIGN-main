      ...
      var b = {
        ...
        removeInputStylingAndMessage: function (a, c) {
          ...
          if (
            ...
            var e = c.inlineErrorMessageCallback(a, c);
            e && e.html("");
        ...
        setInlineMessage: function (b, c, d) {
          ...
          if (f)
            ...
            if (((g = d.inlineErrorMessageCallback(b, d)), !g)) return;
            i();
          } else {
        ...
        setMessageInTopOfForm: function (b, c, d, e) {
          ...
          if (
            ...
            ((g = d.submitErrorMessageCallback(b, c, d)), console.log(g), g)
          ) {
            var h = {
            ...
            e.trigger("formValidationSetup", [e, b]),
              ...
              e
                .bind("submit.validation", function () {
                  ...
                  if (a.formUtils.haltValidation) return !1;
                  if (!d || "function" != typeof b.onSuccess)
                    return d || "function" != typeof b.onError
                      ? d
                      : (b.onError(c), !1);
                  var e = b.onSuccess(c);
                  return e === !1 ? !1 : void 0;
